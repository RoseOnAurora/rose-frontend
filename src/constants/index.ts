...
export const STABLECOIN_SWAP_V2_ADDRESSES: { [chainId in ChainId]: string } = {
  ...
  [ChainId.AURORA_TESTNET]: "0x2A87f49ed6AeB58Ada14086c27652A6891EB73Dc",
  [ChainId.AURORA_MAINNET]: "",
}
...
export const STABLECOIN_SWAP_V2_TOKEN_CONTRACT_ADDRESSES: {
  ...
  [ChainId.AURORA_TESTNET]: "0x9D6348374FafeB8A18050cD5e5A4DF8A723Ade35",
  [ChainId.AURORA_MAINNET]: "",
}
...
const DAI_CONTRACT_ADDRESSES: { [chainId in ChainId]: string } = {
  ...
  [ChainId.AURORA_TESTNET]: "0xC8b374d3c9Ffa111523d5072F89F978fd570E88B",
...
const USDC_CONTRACT_ADDRESSES: { [chainId in ChainId]: string } = {
  ...
  [ChainId.AURORA_TESTNET]: "0xcb1DF98982fFC6567d9662C1ea50184005bB8962",
...
const USDT_CONTRACT_ADDRESSES: { [chainId in ChainId]: string } = {
  ...
  [ChainId.AURORA_TESTNET]: "0x3ce7c6fAc5376fD028406D481eD0bab585Fc3124",
