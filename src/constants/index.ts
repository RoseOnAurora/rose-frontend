...
export const STABLECOIN_SWAP_V2_ADDRESSES: { [chainId in ChainId]: string } = {
  ...
  [ChainId.AURORA_TESTNET]: "0x1f7b8c41ed42d9c22Fc07Ce2D064327496fE1cD0",
  [ChainId.AURORA_MAINNET]: "",
}
...
const DAI_CONTRACT_ADDRESSES: { [chainId in ChainId]: string } = {
  ...
  [ChainId.AURORA_TESTNET]: "0xb4b8F8Cbd9eD3F9866bEcbe4B6e4Cf711563bFc0",
...
const USDC_CONTRACT_ADDRESSES: { [chainId in ChainId]: string } = {
  ...
  [ChainId.AURORA_TESTNET]: "0xdd1d0043f16E5E4056F7cd6c172D7e973E431af9",
...
const USDT_CONTRACT_ADDRESSES: { [chainId in ChainId]: string } = {
  ...
  [ChainId.AURORA_TESTNET]: "0xE22b022cf5AB1a7c739651453b0b5cEE2F7f1164",
