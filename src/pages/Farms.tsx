...
import { FARMS_MAP, Farm, FarmName, LP_TOKEN_MAP } from "../constants"
import {
  FaChartPie,
  FaFilter,
  FaGift,
...
const SORT_FIELDS_TO_LABEL: { [sortField in FarmSortFields]: string } = {
  apr: "APR",
  name: "Name",
  tvl: "TVL",
  dual: "Dual Rewards",
...
function Farms(): ReactElement {
  ...
  const [sortByField, setSortByField] = useState(farmPreferences.farmSortField)
  const [filterByField, setfilterByField] = useState(
    farmPreferences.farmFilterField,
  )
  ...
  const SORT_FUNCTIONS: {
    ...
    dual: (a: Farm, b: Farm) =>
      (farmStats?.[a.name]?.dualReward.token || "") >
      (farmStats?.[b.name]?.dualReward.token || ""),
                ...
                <HStack spacing="5px">
                  ...
                  >
                    <IconButton
                      ...
                      aria-label="sort"
                      title={
                        sortDirection > 0 ? "Sort Ascending" : "Sort Descending"
                      }
                      icon={
                        sortDirection > 0 ? (
                          <FaSortAmountUp />
                  ...
                  >
                    ...
                    >
                      ...
                      <option value={FarmSortFields.DUAL}>
                        Sort by {SORT_FIELDS_TO_LABEL[FarmSortFields.DUAL]}
                      </option>
                  ...
                  >
                    ...
                    >
                      ...
                      <option value={FarmFilterFields.DUAL}>
                        Filter by {FILTER_FIELDS_TO_LABEL[FarmSortFields.DUAL]}
                      </option>
                    </Select>
                  </Box>
                </HStack>
                        ...
                        <Grid gridTemplateRows="auto" rowGap="15px">
                          ...
                          <GridItem>
                            <Flex
                              ...
                              alignItems="center"
                            >
                              <Text fontWeight="600">Show Rewards Tokens?</Text>
                              <Switch
                                onChange={(e) =>
                                  dispatch(
                                    updateFarmRewardsPreferences(
                                ...
                                value={farmPreferences.showRewards}
                                isChecked={
                                  farmPreferences.showRewards > 0 ? true : false
                                }
                                size="md"
                                colorScheme="green"
                              />
                          ...
                          <GridItem>
                            ...
                            <RadioGroup
                              value={farmPreferences.farmSortField}
                              size="sm"
                              defaultValue={"1"}
                            >
                              <Grid
                                    ...
                                    >
                                      <Radio
                                        onChange={(e) =>
                                          dispatch(
                                            updateFarmSortPreferences(
                                              e.target.value as FarmSortFields,
                                            ),
                                          )
                                        }
                                        value={field}
                          ...
                          <GridItem>
                            ...
                            <RadioGroup
                              size="sm"
                              value={farmPreferences.farmFilterField}
                            >
                              <Grid
                                gridTemplateRows="auto"
                                gridTemplateColumns="repeat(2, 1fr)"
                            ...
                            >
                              ...
                              >
                                <ListItem>
                                  ...
                                  />
                                  Add liquidity to one of our pools and receive
                                ...
                                <ListItem>
                                  <ListIcon
                                    ...
                                    color="var(--text-primary)"
                                  />
                                  Click on any of the farm cards to deposit your
                                  LP tokens and earn rewards!
                                </ListItem>
                                <ListItem>
                                  <ListIcon
                                    as={FaGift}
                              ...
                              >
                                <ListItem>
                                  <ListIcon
                                    ...
                                    color="var(--text-primary)"
                                  />
                                  Sort by any of the farm card fields like TVL,
                                  APR & Name.
                                </ListItem>
                                <ListItem>
                                  <ListIcon
                                ...
                                <ListItem>
                                  ...
                                  info for you and apply it each time you visit
                                  the page!
                                </ListItem>
                              </List>
                            </Collapse>
                  ...
                  .map((farm, index) =>
                    ...
                    farmDeposits?.[farm.name] ? (
                      <FarmsOverview
                        ...
                        balance={lpTokenBalances[farm.lpToken.symbol]}
                        deposited={farmDeposits[farm.name]}
